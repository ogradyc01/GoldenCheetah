...
Changing the order of the charts in the 'Charts Bar' is possible. The re-sorting has to take place in the "Tiled" view of the charts. This view can be switched on (as one option) through the [Tool Bar] (https://github.com/GoldenCheetah/GoldenCheetah/wiki/Tool%20Bar_Functions)
