...
* `Download from device...` [explained here](UG_First-Steps_Download-or-import)
* `Import from file...` [explained here](UG_First-Steps_Download-or-import#importing-from-a-file)
...
For further details, please check [Special Topics: Upload_Download to_from external web-sites](UG_Special Topics_Upload_Download to_from external web-sites)
