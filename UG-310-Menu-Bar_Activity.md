...
* `Download from device...` [explained here] (https://github.com/GoldenCheetah/GoldenCheetah/wiki/UG-310-First-Steps_Download-or-import)
* `Import from file...` [explained here] (https://github.com/GoldenCheetah/GoldenCheetah/wiki/UG-310-First-Steps_Download-or-import#importing-from-a-file)
...
* `Upload/Download` [Special Topics: Upload_Download to_from external web-sites] (https://github.com/GoldenCheetah/GoldenCheetah/wiki/UG-310-Special Topics_Upload_Download to_from external web-sites)
