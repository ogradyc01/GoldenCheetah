...
1. if you want to make an existing field of GoldenCheetah editable, please use exactly the field name here and make sure that you use the right field type
