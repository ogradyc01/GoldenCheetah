...
The splash screen will now disapper and reveal the main GoldenCheetah 'Activities' view and you can now start analysing and tracking your performance.

BACK: [First Steps: What you need to do](https://github.com/GoldenCheetah/GoldenCheetah/wiki/UG_First Steps_What you need to do)
