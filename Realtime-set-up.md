...
After you connect the ANT+ stick and the device is created (eg /dev/ttyUSB0) verify that the permissions on the device allow the user to read from the device.
